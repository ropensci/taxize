...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
(traits <- \hlfunctioncall{read.table}(header = TRUE, sep = \hlstring{";"}, text = \hlstring{"taxon;T1M1;T1M2;T1M3;T2M1;T2M2\textbackslash{}nGammarus sp.;0;0;3;1;3\textbackslash{}nPotamopyrgus antipodarum;1;0;3;1;3\textbackslash{}nCoenagrion sp.;3;0;1;3;1\textbackslash{}nEnallagma cyathigerum;0;3;1;0;3\textbackslash{}nErythromma sp.;0;0;3;3;1\textbackslash{}n"}))
\end{alltt}
\begin{verbatim}
...
\begin{verbatim}
                     taxon abundance
1         Gammarus roeseli         5
2         Gammarus roeseli         6
3        Gammarus tigrinus         7
4        Gammarus tigrinus         8
5           Coenagrionidae        10
6           Coenagrionidae         6
7 Potamopyrgus antipodarum        10
\end{verbatim}
\end{kframe}
\end{knitrout}
