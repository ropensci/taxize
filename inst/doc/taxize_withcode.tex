...
\begin{itemize}
    \item{Appendix A.} A complete reproducible workflow, showing how you can go from a species list, to resolve taxonomic names, get common names, get higher taxonomic classification, and a phylogeny. 
\end{itemize}
