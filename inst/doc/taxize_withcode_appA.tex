...
\hlfunctioncall{registerDoMC}(cores = 4)  \hlcomment{# I have a mac, so using doMC package, use whatever you like}
...
{\centering \includegraphics[width=.8\linewidth,height=4in]{figure/phylogeny} 
...
{\centering \includegraphics[width=\maxwidth,height=4in]{figure/map} 
