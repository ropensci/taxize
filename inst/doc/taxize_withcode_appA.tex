...
Retrieving data for species ' Collomia grandiflora '

Retrieving data for species ' Abies magnifica '

Retrieving data for species ' Rosa californica '

Retrieving data for species ' Datura wrightii '

Retrieving data for species ' Mimulus bicolor '

Retrieving data for species ' Nicotiana glauca '

Retrieving data for species ' Madia sativa '

Retrieving data for species ' Bartlettia scaposa '
\end{verbatim}
\begin{alltt}
...
{\centering \includegraphics[width=\maxwidth]{figure/phylogeny} 
...
p <- \hlfunctioncall{gbifmap}(occurr_list) + \hlfunctioncall{guides}(col = \hlfunctioncall{guide_legend}(title = \hlstring{""}, nrow = 2, 
    byrow = TRUE)) + \hlfunctioncall{theme}(legend.position = \hlstring{"bottom"}, legend.key = \hlfunctioncall{element_blank}())
p
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=\maxwidth]{figure/map} 
