...
\begin{alltt}
(traits <- \hlfunctioncall{read.table}(header = TRUE, sep = \hlstring{';'}, stringsAsFactors=FALSE, text = 'taxon;T1M1;T1M2;T1M3;T2M1;T2M2
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
(abundances <- \hlfunctioncall{read.table}(header = TRUE, sep = \hlstring{';'}, stringsAsFactors=FALSE, text = 'taxon;abundance;sample
