...
<<resolvenames, eval=FALSE, cache=TRUE>>=
...
<<itisclass, eval=FALSE,cache=TRUE>>=
...
<<interactive_na, eval=FALSE, echo=TRUE, cache=TRUE>>=
...
<<downstream, eval=FALSE, cache=TRUE>>=
...
<<genbank_one, eval=FALSE, cache=TRUE>>=
...
<<genbank_two, eval=FALSE, cache=TRUE>>=
