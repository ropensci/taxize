...
A number of data sources in taxize provide the capability to retrieve higher taxonomic names, but we will highlight two of the more useful ones: ITIS and NCBI. First, we'll search for two species, \emph{Abies procera} and \emph{Pinus contorta}.
