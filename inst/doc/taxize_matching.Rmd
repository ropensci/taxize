...
```{r traitdata, tidy=FALSE, comment=NA, message=FALSE, warning=FALSE}
...
```{r abundancedata, tidy=FALSE, comment=NA, message=FALSE, warning=FALSE}
...
```{r cleaning, comment=NA, message=FALSE, warning=FALSE}
...
```{r get_classification, cache=TRUE, comment=NA, message=FALSE, warning=FALSE}
library(taxize)
...
```{r direct_matches, comment=NA, message=FALSE, warning=FALSE}
...
```{r higher_resolution, comment=NA, message=FALSE, warning=FALSE}
...
```{r lower_resolution, message=FALSE, warning=FALSE}
...
```{r na_omit, message=FALSE, warning=FALSE}
