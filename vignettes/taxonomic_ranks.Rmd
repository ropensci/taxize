...
- `rank_ref_zoo`: same as above but more specifically for zoological rank systems; as of this writing only used for WoRMS; `rank_ref` is used for all other data sourcdes

We reference this rank information in `classification()`, `tax_name()`, and all of the exported `downstream` functions.
