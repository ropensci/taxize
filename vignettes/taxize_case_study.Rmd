...
*Species Plantarum* by Carl Linnaeus originally published in 1753 and was the first work to consistently describe species using binominal names. It provides useful reference point to chart how the 5940 taxa described within have changed since their inception. So let's use the taxize package see if we can resolve these names and see if any of them have changed. 
...
# use resolve function to send binominal names to resolver
