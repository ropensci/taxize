...
<<resolvenames, cache=TRUE, size='scriptsize'>>=
...
<<tnrs, cache=TRUE, size='scriptsize'>>=
...
<<synonyms, cache=TRUE, message=FALSE, warning=FALSE, size='scriptsize'>>=
library(plyr)
...
<<taxname, cache=TRUE, size='scriptsize'>>=
...
<<interactive_many, cache=TRUE, size='scriptsize'>>=
