...
opts_chunk$set(fig.align='center', fig.show='hold', par=TRUE, warning=FALSE, message=FALSE, error=FALSE, comment=NA)
@
...
<<resolvenames, results='hide', cache=TRUE, size='scriptsize'>>=
temp <- gnr_resolve(names = c("Helianthos annus", "Homo saapiens"))
temp[ , -c(1,4)]
@

<<resolvenames1, echo=FALSE, cache=TRUE, size='scriptsize'>>=
temp[ , -c(1,4)]
@
...
<<tnrs, results='hide', cache=TRUE, size='scriptsize'>>=
...
<<tnrs1, echo=FALSE, cache=TRUE, size='scriptsize'>>=
tnrs(query = mynames)[ , -c(5:7)]
@
...
<<synonyms, results='hide', cache=TRUE, message=FALSE, warning=FALSE, comment=NA, size='scriptsize'>>=
library(plyr)
...
<<synonyms1, echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE, comment=NA, size='scriptsize'>>=
library(plyr)
mynames <- c("Helianthus annuus ssp. jaegeri", "Helianthus annuus ssp. lenticularis", "Helianthus annuus ssp. texanus", "Helianthus annuus var. lenticularis", "Helianthus annuus var. macrocarpus", "Helianthus annuus var. texanus")
tsn <- get_tsn(mynames)
ldply(tsn, itis_acceptname)
...
<<itisclass, results='hide', cache=TRUE, size='scriptsize'>>=
specieslist <- c("Abies procera","Pinus contorta")
classification(specieslist, db = 'itis')
@

<<itisclass1, echo=FALSE, cache=TRUE, size='scriptsize'>>=
specieslist <- c("Abies procera","Pinus contorta")
classification(specieslist, db = 'itis')
@
...
<<interactive, results='hide', cache=TRUE, size='scriptsize'>>=
get_tsn(searchterm = "Heliastes", searchtype = "sciname")
@

<<interactive1, echo=FALSE, cache=TRUE, size='scriptsize'>>=
get_tsn(searchterm = "Heliastes", searchtype = "sciname")
@

In another example, you can pass in a long character vector of taxonomic names:

<<interactive_many, results='hide', cache=TRUE, size='scriptsize'>>=
splist <- c("annona cherimola", 'annona muricata', "quercus robur",
  	"shorea robusta", "pandanus patina", "oryza sativa", "durio zibethinus")
get_tsn(searchterm = splist, searchtype = "sciname")
@

<<interactive_many1, echo=FALSE, cache=TRUE, size='scriptsize'>>=
splist <- c("annona cherimola", 'annona muricata', "quercus robur",
    "shorea robusta", "pandanus patina", "oryza sativa", "durio zibethinus")
get_tsn(searchterm = splist, searchtype = "sciname")
@
...
<<interactive_na, results='hide', cache=TRUE, size='scriptsize'>>=
get_uid(sciname = c("Chironomus riparius", "aaa vva"))
@

<<interactive_na1, echo=FALSE, cache=TRUE, size='scriptsize'>>=
get_uid(sciname = c("Chironomus riparius", "aaa vva"))
@
...
<<downstream, results='hide', cache=TRUE, size='scriptsize'>>=
col_downstream(name = "Apis", downto = "Species")[[1]]
@

<<downstream1, echo=FALSE, cache=TRUE, size='scriptsize'>>=
col_downstream(name = "Apis", downto = "Species")[[1]]
@
...
<<iucn, results='hide', cache=TRUE, size='scriptsize'>>=
ia <- iucn_summary(c("Panthera uncia", "Lynx lynx"))
iucn_status(ia)
@

<<iucn1, echo=FALSE, cache=TRUE, size='scriptsize'>>=
ia <- iucn_summary(c("Panthera uncia", "Lynx lynx"))
iucn_status(ia)
@
...
<<genbank_one, eval=TRUE, cache=TRUE, size='scriptsize'>>=
...
<<genbank_two, results='hide', cache=TRUE, size='scriptsize'>>=
out[grep("RAG1", out$genesavail, ignore.case = TRUE), -3]
@

<<genbank_two1, echo=FALSE, cache=TRUE, size='scriptsize'>>=
out[grep("RAG1", out$genesavail, ignore.case = TRUE), -3]
@
...
<<tax_match, results='hide', cache=TRUE, tidy=FALSE, size='scriptsize'>>=
A <- "gammarus roeseli" 
...
<<tax_match1, echo=FALSE, cache=TRUE, tidy=FALSE, size='scriptsize'>>=
B1[match(A, B1)]
@

<<tax_match2, results='hide', cache=TRUE, tidy=FALSE, size='scriptsize'>>=
A_clas[[1]]$Rank[tolower(A_clas[[1]]$ScientificName) %in% B2]
@

<<tax_match3, echo=FALSE, cache=TRUE, tidy=FALSE, size='scriptsize'>>=
A_clas[[1]]$Rank[tolower(A_clas[[1]]$ScientificName) %in% B2]
@

<<tax_match4, results='hide', cache=TRUE, tidy=FALSE, size='scriptsize'>>=
A_clas[[1]]$Rank[tolower(A_clas[[1]]$ScientificName) %in% B3]
@

<<tax_match5, echo=FALSE, cache=TRUE, tidy=FALSE, size='scriptsize'>>=
A_clas[[1]]$Rank[tolower(A_clas[[1]]$ScientificName) %in% B3]
@
...
<<tax_agg, results='hide', cache=TRUE, tidy=FALSE, size='scriptsize'>>=
data(dune, package = 'vegan')
df <- dune[ , c(1,3:4)]
colnames(df) <- c("Bellis perennis", "Juncus bufonius", "Juncus articulatus")
head(df)
@

<<tax_agg1, echo=FALSE, cache=TRUE, tidy=FALSE, size='scriptsize'>>=
head(df)
@

<<tax_agg2, results='hide', cache=TRUE, tidy=FALSE, size='scriptsize'>>=
agg <- tax_agg(df, rank = 'family', db = 'ncbi')
agg
@

<<tax_agg3, echo=FALSE, cache=TRUE, tidy=FALSE, size='scriptsize'>>=
agg
@

<<tax_agg4, results='hide', cache=TRUE, tidy=FALSE, size='scriptsize'>>=
head(agg$x)
@

<<tax_agg5, echo=FALSE, cache=TRUE, tidy=FALSE, size='scriptsize'>>=
head(agg$x)
@
