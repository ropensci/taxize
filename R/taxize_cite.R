...
data_citations <- function(x){
  switch(x,
    ...
    get_ids = list(itis = c_itis, col = c_col, ncbi = c_ncbi, gbif = c_gbif, eol = c_eol,
                   tropicos = c_tropicos, nbn = c_nbn, ubio = c_ubio),
    ...
    get_ubioid = list(ubio = c_ubio),
    get_ubioid_ = list(ubio = c_ubio),
    ...
    ubio_classification = list(ubio = c_ubio),
    ubio_classification_search = list(ubio = c_ubio),
    ubio_id = list(ubio = c_ubio),
    ubio_ping = list(ubio = c_ubio),
    ubio_search = list(ubio = c_ubio),
    ubio_synonyms = list(ubio = c_ubio),
